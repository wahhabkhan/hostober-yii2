...
<?=$form->field($model, 'main_markets')->textInput(['maxlength' => true])?>

<?=$form->field($model, 'brands')->textInput(['maxlength' => true])?>

<?=$form->field($model, 'giz_interventions')->textarea(['rows' => 6])?>

<?=$form->field($model, 'focal_person_contact_details_id')->textarea(['rows' => 6])?>

<?=$form->field($model, 'address_id')->textarea(['rows' => 6])?>

<?=$form->field($model, 'organization_id')->textarea(['rows' => 6])?>
