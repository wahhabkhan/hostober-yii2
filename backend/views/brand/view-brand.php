...
$this->title = 'Government Table View';
...
<div class="government-view ms-5">
    ...
    <table style="margin-left:95px" class="table table-bordered ">
        <tr>
            ...
            <th>Brand Name</th>
            <th>Main Products</th>
            <th>Purchasing Capacity</th>
            <th>Main Purchasing Markets</th>
            <th>Main Sales Markets</th>
            <th>GIZ Interventions History</th>
            <th>Focal Person Contact ID</th>
            <th>Physical Address ID</th>
            <th>Action</th>
        </tr>
        <?php foreach ($models as $model): ?>
            <tr>
                ...
                <td><?=$model->main_products?></td>
                <td><?=$model->purchasing_capacity?></td>
                <td><?=$model->main_purchasing_markets?></td>
                <td><?=$model->main_sales_markets?></td>
                <td><?=$model->giz_interventions_history_id?></td>
                <td><?=$model->focal_person_contact_id?></td>
                <td><?=$model->physical_address_id?></td>
                <td>
