  ...
  <div class="sidebar">
    ...
    <nav class="nav flex-column">
      ...
      <div class="sub-menu" id="government">
        <a href="add-government">Add Government</a>
        <a href="view-government">View Government</a>
      </div>
      ...
      <div class="sub-menu" id="multiplier">
        <a href="add-multiplier">Add Multiplier</a><br>
        <a href="view-multiplier">View Multiplier</a>
      </div>
      ...
      <div class="sub-menu" id="factory">
        <a href="add-factory">Add Factory</a><br>
        <a href="view-factory">View Factory</a>
      </div>
      ...
      <div class="sub-menu" id="association">
        <a href="add-association">Add Association</a><br>
        <a href="view-association">View Association</a>
      </div>
      ...
      <div class="sub-menu" id="partner">
        <a href="add-partner">Add General-Partner</a><br>
        <a href="view-partner">View General-Partner</a>
      </div>
      ...
      <div class="sub-menu" id="brand">
        <a href="add-brand">Add Brands</a><br>
        <a href="view-brand">View Brands</a>
      </div>
      ...
      <div class="sub-menu" id="academia">
        <a href="add-academia">Add Academia</a><br>
        <a href="view-academia">View Academia</a>
      </div>
    </nav>
  </div>
