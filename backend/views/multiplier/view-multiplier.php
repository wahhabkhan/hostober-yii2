...
$this->title = 'Multiplier Table View';
...
<div class="multiplier-view ms-5">
    <h4 style="margin-left:90px"><?=Html::encode($this->title)?></h4>

    <table style="margin-left:90px" class="table table-bordered ">
        <tr>
            <th>ID</th>
            <th>Size</th>
            <th>Products</th>
        ...
        <?php foreach ($models as $model): ?>
            <tr>
                ...
                <td><?=$model->giz_interventions?></td>
                <td><?=$model->focal_person_contact_details_id?></td>
                <td><?=$model->address_id?></td>
